...
namespace Vim.VisualStudio
{
    ...
    internal sealed class VsCommandTarget : IOleCommandTarget
    {
		...
		private void CloseCapsLock()
		{
			if (System.Console.CapsLock)       // 方法1：表示CapsLock 键打开
		    //if (System.Windows.Forms.Control.IsKeyLocked(System.Windows.Forms.Keys.CapsLock)) //方法2：表示CapsLock 键打开//
			{
				keybd_event(0x14, 0x3A, KEYEVENTF_EXTENDEDKEY, (UIntPtr)0);
				keybd_event(0x14, 0x3A, KEYEVENTF_EXTENDEDKEY | KEYEVENTF_KEYUP, (UIntPtr)0);
			}
		}
		//.>
